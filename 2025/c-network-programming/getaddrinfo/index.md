...
倘若你对上述说法觉得奇怪甚至荒谬，那么请思考这样一个问题，一个普通的计算机用户，他要上网，在十多年前，他可能还需要知道 IP 地址、网关、DNS 等概念以及如何为操作系统设置它们，而在现在，他只需知道可用的 WIFI 的名字，他不需要对网络原理以及网络编程有任何了解。

我们编写网络程序，自然是以网络体系已经存在且能正常运行为前提，故而可以无需关心其原理和内幕如何，亦即你无需知道 OSI 模型是什么，Internet 四层架构是什么，架构的每一层有哪些协议，在计算机操作系统中如何实现这些协议，以及 TCP 协议需要几次握手和几次挥手……你只需要知道什么是 IP 地址，什么是域名，便已足够。当然，单就阅读本文及其后续一系列文章，你需要熟悉 C 语言，但也无需精通。

也许你在找与网络通信相关的工作，面试官可能会考问这些我觉得不重要的东西，此时，你的确需要知道它们。不过，当你学会网络编程之后再去学习网络原理，也许你更能知其所以然。

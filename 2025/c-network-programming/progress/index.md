...
现在明白，有些人类为什么也喜欢拼爹了吧？因为他们想当僵尸进程。不过，主要原因还是爹不够负责，他对子进程完全放任不管。拼爹的人，也挺可怜的，他们也许潜意识里，只是想证明，自己是有父亲的。
...
本文不可能是多进程并发编程的全部知识，但是对于驱散网络编程上空的第二朵乌云，似乎已经够用了。现在先休息一下，喝杯春茶，打量一下这个多进程的世界。

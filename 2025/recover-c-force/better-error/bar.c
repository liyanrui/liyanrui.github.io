...
SimStr *sim_str(const char *raw, SimErr *e);
void sim_str_free(SimStr *str, SimErr *e);

size_t sim_str_size(SimStr *str, SimErr *e);
const char *sim_str_raw(SimStr *str, SimErr *e);

void sim_str_insert(SimStr *str, size_t index, const char *raw, SimErr *e);
void sim_str_prepend(SimStr *str, const char *raw, SimErr *e);
void sim_str_append(SimStr *str, const char *raw, SimErr *e);

size_t sim_str_find(SimStr *str, const char *target, SimErr *e);
void sim_str_delete(SimStr *str, size_t begin, size_t n, SimErr *e);
# 3 "foo.c" 2

int main(void) {
        SimErr e;
        char *w = "world";
        SimStr *a = sim_str(w, &e);
        printf("%s\n", sim_str_raw(a, &e));

        char *h = "hello";
        sim_str_prepend(a, h, &e);
        sim_str_insert(a, strlen(h), " ", &e);
        sim_str_append(a, "!", &e);
        printf("%s\n", sim_str_raw(a, &e));

        sim_str_delete(a, sim_str_find(a, w, &e), strlen(w), &e);
        sim_str_delete(a, strlen(h), 1, &e);
        printf("%s\n", sim_str_raw(a, &e));

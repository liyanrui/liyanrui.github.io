...
这段时间，我几乎又将 Awk 语言完整地学习了一遍，事实证明，我以前只是假装会了 Awk 的用法。这次在 C 语言源码渲染方面的实践驱动的学习中，我发现了 Awk 语言一些细节。基于这些细节，可以大幅简化之前所写的一些 Awk 脚本。虽然此处已是总结，但未来在用 Awk 语言解决一些实际问题时，可能还会更新这份文档。也许，这次我只是又一次假装学会了。我的生活，就在一场又一场假装中，踉跄前进

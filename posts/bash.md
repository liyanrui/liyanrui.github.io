...
很容易去问，为什么会有两种字串？其实应该去问，为什么人类发明的文字里要有两种引号？在与他人的对话中，我说说的话可以用双引号包围起来。例如：
...
单引号可以出现在双引号里，这意味着什么？意味着双引号更为宽松，而单引号则比双引号更为紧致。宽松的可以包含紧致的。对于 Bash 而言，双引号字串的宽松体现于，双引号字串中如果含有一些对于 Bash 有特殊含义的字符，Bash 会使用这些字符的含义代替这些字符。例如，

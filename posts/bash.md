...
图形界面与命令并不冲突。我们教孩子说话，一开始也是以指物的方式，让孩子获得了基本的语言交流能力。图形界面程序为计算机的普及作出了很大贡献，但是在这个基础上，若想让计算机更准确、高效地理解我们的意图，那么便需要学习一门语言了。
...
四两拨千斤，并不神奇。你的车若是抛锚了，若想将它运送到修理厂，只需拨打一个特定的电话，不一会的工夫就会出现一辆拖车，它会将你的车运到修理厂。学习计算机语言，也能够在计算机的世界里获得这样的能力，获得这一能力并不需要去读计算机科学专业的学位，如同学习开车并不需要你去读车辆工程专业的学位。

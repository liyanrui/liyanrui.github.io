...
$$
\frac{\begin{pmatrix} N_1\\\\ m_{11}\end{pmatrix}\cdots\begin{pmatrix} N_k\\\\ m_{1k}\end{pmatrix}\begin{pmatrix} N_1\\\\ m_{21}\end{pmatrix}\cdots\begin{pmatrix} N_k\\\\ m_{2k}\end{pmatrix}\cdots\begin{pmatrix} N_1\\\\ m_{r1}\end{pmatrix}\cdots\begin{pmatrix} N_k\\\\ m_{rk}\end{pmatrix}}{\begin{pmatrix} 50\\\\ m\end{pmatrix}} \ge 90%
$$
